...
<!--**********************************
        ...
        ***********************************-->
        ...
        <p class="brand-title" width="124px" height="33px"  style="font-size: 25px;">Asia Shop</p>
            </a>
            ...
            <div class="header-content">
              ...
              <li class="nav-item dropdown notification_dropdown">
                  ...
                  <span class="badge light text-white bg-primary rounded-circle">2</span>
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" href="/stock-alerts">
